...
public class ImageLoader {
    ...
    public static void loadImageBlur(final SimpleDraweeView draweeView, final View backView, final String url) {
        loadImage(draweeView.getContext(), url, new IResult<Bitmap>() {

            @Override
            public void onResult(Bitmap source) {
                draweeView.setImageBitmap(source);
                if (draweeView.getTag() != null && draweeView.getTag().equals(url)) {
                    Bitmap blurBitmap = BitmapBlurHelper.blur(backView.getContext(), source);
                    backView.setBackground(new BitmapDrawable(blurBitmap));
    ...
    public static void loadImageBlur(final ImageView icon, final View bgView, final View barLay, final String url) {
        loadImage(icon.getContext(), url, new IResult<Bitmap>() {

            @Override
            public void onResult(Bitmap source) {
                icon.setImageBitmap(source);
                Bitmap blurBitmap = BitmapBlurHelper.blur(icon.getContext(), source);
                bgView.setBackground(new BitmapDrawable(blurBitmap));
                if(barLay!=null){
                    barLay.setBackground(new BitmapDrawable(blurBitmap));
                }
            }
        });
    }

    public static void loadImage(final View view, String url, final int reqWidth, final int reqHeight) {
