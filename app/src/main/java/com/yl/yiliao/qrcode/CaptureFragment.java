...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback ,View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.capture_back).setOnClickListener(this);

        flashLight = view.findViewById(R.id.light);
    ...
    public void switchFlashImg(int flashState) {
        ...
        if (flashState == R.id.flash_open) {
            flashLight.setImageResource(R.drawable.ic_light);
        } else {
            flashLight.setImageResource(R.drawable.ic_light_sel);
        }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.light:
                ...
                break;
            case R.id.photo:
                ((CaptureActivity)getActivity()).requestPermissionAlbum();
                break;
        }
