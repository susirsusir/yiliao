...
//        a.recycle();
        ...
        indicatorPadding = a.getDimensionPixelSize(
                R.styleable.PagerSlidingTabStrip_pstsIndicatorPadding,
                indicatorPadding);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            addTab(i, ((ViewPagerFragmentAdapter) pager.getAdapter()).getView(i));
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mLineRect.left = lineLeft + indicatorPadding;
        mLineRect.top = height - indicatorHeight + underLineMarginBottom;
        mLineRect.right = lineRight - indicatorPadding;
        mLineRect.bottom = height + underLineMarginBottom;

        canvas.drawRoundRect(mLineRect, 8, 8, rectPaint);
