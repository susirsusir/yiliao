...
public class DialogManager {
    ...
    public void showRecordingDialog() {
        ...
        lp.y = IntegerUtils.dp2px(80, mContext);
    ...
    public void recording() {
        if (mDialog != null && mDialog.isShowing()) {
            ...
            mLable.setText(R.string.chat_voice_up_cancel);
        }
    }
    ...
    public void wantToCancel() {
        if (mDialog != null && mDialog.isShowing()) {
            ...
            mLable.setText(R.string.chat_voice_let_cancel);
        }
    }
    ...
    public void arriveTime(float time) {
        if (mDialog != null && mDialog.isShowing()) {
            int s = (int) (30 - time);
            mLable.setText("还可以说" + s + "s");
        }
    }
    ...
    public void tooShort() {
        if (mDialog != null && mDialog.isShowing()) { //显示状态
            ...
            mLable.setText(R.string.chat_voice_to_short);
        }
    }
